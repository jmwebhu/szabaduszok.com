...
class Kohana_TextTest extends Unittest_TestCase
{
	...
	public function test_user_agent_accepts_array()
	{
        ...
        /**
         * @covers Text::isId
         * @dataProvider testIsIdDataProvider
         */
        public function testIsId($actual, $expected)
        {
            $this->assertEquals(Text::isId($actual), $expected);
        }
        
        public function testIsIdDataProvider()
        {
            return [
                ['1', true],
                [12, true],
