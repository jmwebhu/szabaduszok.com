...
class Controller_User_Create_Employer extends Controller_DefaultTemplate
{
    /**
     * @var string
     */
    ...
    public function action_index()
    {
        try {
            $this->setContext();
            $this->handleSignup();
            Model_Leadmagnet::sendTo($this->_email, Entity_User::TYPE_EMPLOYER);
            ...
            if ($this->request->method() == Request::POST) {
                ...
                if (!$this->_error) {
                    ...
                    header('Location: ' . Route::url('projectOwnerProfile', ['slug' => $this->_user->getSlug()]), true, 302);
                    die();
                }
            }
        }
