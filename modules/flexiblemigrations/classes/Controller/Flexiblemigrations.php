...
class Controller_Flexiblemigrations extends Kohana_Controller_Template {
  ...
  protected $view;
	...
	public function action_index() 
	{
		...
		//$migrations_runned = DB::select('hash')->from('migrations')->execute()->get('hash');
		$migrations_runned_temp = ORM::factory('Migration')->find_all();
		$migrations_runned = [];
		foreach ($migrations_runned_temp as $tmp)
		{
			$migrations_runned[] = $tmp->hash;
		}
