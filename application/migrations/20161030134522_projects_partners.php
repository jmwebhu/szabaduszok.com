...
class projects_partners extends Migration
{
  public function up()
  {
     ...
     (
       ...
       (
           ...
           'notification_id'    => ['integer', 'default' => null, 'unsigned' => true],
      ...
      $this->add_index('projects_partners', 'type', ['type'], 'normal');
      ...
      $this->sql("ALTER TABLE `projects_partners` ADD FOREIGN KEY (`notification_id`) REFERENCES `notifications`(`notification_id`) ON DELETE SET NULL ON UPDATE CASCADE");
  }
  ...
  public function down()
  {
      ...
      $this->sql("ALTER TABLE `projects_partners` DROP FOREIGN KEY notification_id");
