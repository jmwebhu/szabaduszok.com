...
if (isset($baseconfig['env']))
{
	Kohana::$environment = $baseconfig['env'];	
}
else
{
	Kohana::$environment = (!isset($_SERVER['SERVER_ADDR']) || stripos($_SERVER['SERVER_ADDR'], '127.0.0.1') !== false || stripos($_SERVER['SERVER_ADDR'], 'localhost') !== false) ? Kohana::DEVELOPMENT : Kohana::PRODUCTION;
}
...
Kohana::modules(array(
    ...
    'twig'		=> MODPATH.'twig',       // Basic authentication
    'project'	=> MODPATH.'project',       // Basic authentication
	...
	'api'		=> MODPATH.'api',		// Kulso szolgaltatasokhoz tartozo API. pl MailMaster
...
require APPPATH.'config/routing'.EXT;
require APPPATH.'config/assets'.EXT;
